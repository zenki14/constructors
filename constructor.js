...
// var Dog = 
// function sadie(name, color, hungry, owner, status) {
//   this.name = 'sadie';
//   this.color = 'black';
//   this.hungry = false;
//   this.owner = 'mason';
...
// function moonshine(name, color, hungry, owner, status) {
//   this.name = 'moonshine';
//   this.color = 'blue-red';
//   this.hungry = true;
//   this.owner = owner;
...
// var Human = 
// function mason(name, status, cool, feed, owner) {
//   this.name = name;
//   this.status = status;
//   this.cool = false;
//   this.pet = function(Dog){
...
// }
// function julia(name, status, cool, feed, owner) {
//   this.name = name;
//   this.status = status;
//   this.cool = true;
//   this.feed = feed;
